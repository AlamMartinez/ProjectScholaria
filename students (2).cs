...
public class Student
{
    ...
    public Student(int id)
    {
        this.id = id;
        travel = 0;
        happiness = 80; // Initialize happiness to 80
    }

    /// <summary>
    /// Gets the current happiness value of the student.
    /// </summary>
    /// <returns>Happiness value</returns>
    ...
    /// <summary>
    /// Increases the student's happiness by a given value.
    /// Ensures happiness does not exceed 100.
    /// </summary>
    /// <param name="amount">The amount to increase happiness by</param>
    ...
    /// <summary>
    /// Decreases the student's happiness by a given value.
    /// Ensures happiness does not go below 0.
    /// </summary>
    /// <param name="amount">The amount to decrease happiness by</param>
