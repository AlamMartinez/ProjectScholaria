...
public class ScoreSystem
{
    ...
    public ScoreSystem(GameManager gameManager, PlacementManager placementManager, TimeManager timeManager)
    {
    ...
    public void UpdateExp()
    {
        ...
        currExp += timeManager.GetTimeVar();
    ...
    public int CalcScore()
    {
        ...
        totalScore = (buildings.Count * 20) + (students.Count * (int)overallHappiness * 10)
            + (currLevel * 100) + (timeManager.GetTimeVar() * 10);
        return totalScore;
    }

    public void DecreaseScore(double percentage)
    {
        double decreaseAmount = (double)totalScore * percentage;
        totalScore = totalScore - (int)decreaseAmount;
        return;
    }
